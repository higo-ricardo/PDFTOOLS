...
from core.services.image_extractor import ImageExtractorService
...
# Tabs da interface
from gui_tkinter.image_extractor_tab import ImageExtractorTab
...
class PDFToolsApp(ctk.CTk):
    ...
    def _setup_ui(self):
        ...
        self.image_extractor_tab = self.tabview.add("🖼️ Extrair Imagens")
        ...
        self.image_extractor_frame = ImageExtractorTab(self.image_extractor_tab)
        self.image_extractor_frame.pack(fill="both", expand=True, padx=12, pady=12)
